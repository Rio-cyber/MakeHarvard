String.prototype.has = function() {
  ...
  **/
  ...
  var sts = [
    /*[0]*/
    'So, lets start?... Welcome to Valen-time.^',
    /*[1]*/
  ...
  _your_color_react = function() {
    if (your_color.value != '' && si == 3) {
      ...
      sts[4] = 'Terrific. ' + yourcolor + ' will be a dominating your profile that can help you to find your perfect date._You do realize we are kidding, right?_^'
      si = 4;
      ii = 4;
  ...
  _send_pitch = function() {
    if (type.innerHTML.length == 0) {
      ...
      _type();
    } else if (type.innerHTML.length < 20 && type.innerHTML.length > 0) {
      sts[6] = 'You can\'t be serious, ' + yourname + '. Your pitch is shorter for you to find your perfect date. Give us at least 100 characters.';
      _type();
    } else if (type.innerHTML.length < 60 && type.innerHTML.length >= 20) {
      sts[6] = 'Keep working, ' + yourname + '. You are still ' + (100 - type.innerHTML.length) + ' characters short.';
      _type();
    } else if (type.innerHTML.length < 100 && type.innerHTML.length >= 60) {
      sts[6] = 'Just a little more, ' + yourname + '. Give us ' + (100 - type.innerHTML.length) + ' characters more.';
      _type();
      ...
      sts[7] = 'All right, ' + yourname + '. I think we have everything we need. Lets find your perfect match^';
      si = 7;
      ii = 7;
      _update_step();
      _type();
